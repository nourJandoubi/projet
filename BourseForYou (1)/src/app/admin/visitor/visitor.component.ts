 ...
 visitorsYear(year: any) 
{
  for (let i = 1; i < 13; i++) 
  {
    this.visitorService.getVisitorsByMonth(year,i).subscribe((response)=>
    {
...
//---------------Visitors---------------------------------//  
    ...
    this.visitorService.getVisitorsByYear(this.selectedYearVY).subscribe((response)=>
    { 
        this.totalYearV=response.total;
    });
    this.visitorService.getVisitorsByMonth(this.selectedYearVM,this.selectedMonthVM).subscribe((response)=>
    {
        this.totalMonthV=response.total;
    });
    this.visitorService.getVisitorsByLastWeek().toPromise().then((response)=>{
